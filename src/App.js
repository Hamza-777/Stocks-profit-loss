      ...
      <div className="container">
        ...
        <div className="inputs">
          <div className="number flex">
            ...
            <input id="prev" type="number" value={previous} onChange={changeHandler} />
          </div>
          <div className="number flex">
            <h4>Total number of stocks purchased: </h4>
            <input id="count" type="number" value={number} onChange={changeHandler} />
          </div>
          <div className="number flex">
            <h4>Current price: </h4>
            <input id="current" type="number" value={current} onChange={changeHandler} />
          </div>
        </div>
